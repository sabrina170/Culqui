...
<div class="container">
		<button type="submit" class="btn btn-primary" id="buyButton" name="prePago" title="Procesar con el Pago">Total a Pagar</button>
    </div>
  ...
  <script>
    Culqi.publicKey = 'pk_test_4ac351202055b8d7';
